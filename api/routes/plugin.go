...
func RegisterPluginRoutes(router *gin.RouterGroup) {
	// Get all plugins
	...
	// Install a plugin
	router.POST("/:name/install", func(c *gin.Context) {
		name := c.Param("name")
	...
	// Uninstall a plugin
	router.POST("/:name/uninstall", func(c *gin.Context) {
		name := c.Param("name")
	...
	// Enable a plugin
	router.POST("/:name/enable", func(c *gin.Context) {
		name := c.Param("name")
	...
	// Disable a plugin
	router.POST("/:name/disable", func(c *gin.Context) {
		name := c.Param("name")
	...
	// Get plugin settings
	router.GET("/:name/settings", func(c *gin.Context) {
		name := c.Param("name")
	...
	router.PUT("/:name/settings", func(c *gin.Context) {
		name := c.Param("name")
